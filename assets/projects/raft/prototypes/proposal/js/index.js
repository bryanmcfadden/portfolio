var Index = function () {
    return {
		...
		// ******************************************************
		// ******* MY PROJECT CHARTS STARTS HERE ****************
		// ******************************************************
		// ***** This chart has 2 views
		// ***** view 1: Visual Map display w/rollovers
		// ***** view 2: List view
		// ******************************************************
		// ******************************************************
        initCharts: function () {
			...
			// CHARTING ROLLOVER TOOLTIPS 
            function showTooltip(title, x, y, contents) {
                $('<div id="tooltip" class="chart-tooltip">'+
					' <div class="date">' + title + 
					'<\/div><div class="label label-success">CTR: ' + 
					x / 10 + 
					'%<\/div><div class="label label-danger">Imp: ' + 
					x * 12 + 
					'<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                ...
                $("#site_activities").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
							...
							showTooltip('Project 233949', item.pageX, item.pageY, x);
                        }
                    }
                });
